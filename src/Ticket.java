...
public class Ticket {
  ...
  private String contentTicket = "\n{{nameLocal}}\n"+
    "{{expedition}}\n"+
    "Domicilio:Hidalgo #12\n          Entre Jalisco y \n          Aguascalientes\n"+
     "Col. Centro\n"+
    "Telefonos:(325)6880668 \n          (325)1013284 \n "+    
    "=============================\n"+
    "Cliente:{{cliente}}\n"+
    "Mesa:{{mesa}}\n"+
    "{{domicilio}} \n"+   
  ...
  Ticket(String nameLocal, String expedition,String cliente,String domicilio , String box, String ticket, String caissier, String dateTime, String items, String subTotal, String tax, String total, String recibo, String change,String mesa) {
    ...
    this.contentTicket = this.contentTicket.replace("{{domicilio}}", domicilio);
